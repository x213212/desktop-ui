...
Singleton {
    ...
    component BrightnessMonitor: QtObject {
        ...
        Behavior on multipliedBrightness {
            // Initialization must be a read-only state sync. Animating from
            // QML's default 0 would otherwise write a near-zero value to the
            // real panel before climbing back to the saved brightness.
