...
Singleton {
    ...
    property string googleSyncCacheDir: FileUtils.trimFileProtocol(`${Directories.cache}/uios-google-sync`)
    property string gmailCachePath: `${Directories.googleSyncCacheDir}/gmail.json`
    property string googleCalendarCachePath: `${Directories.googleSyncCacheDir}/calendar.json`
    ...
    Component.onCompleted: {
        ...
        Quickshell.execDetached(["mkdir", "-m", "700", "-p", `${googleSyncCacheDir}`])
