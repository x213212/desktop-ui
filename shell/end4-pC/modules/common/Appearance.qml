...
Singleton {
    ...
    animationCurves: QtObject {
        // 60 Hz-friendly, non-overshooting motion.  The previous curves went
        // above 1.0 and then crawled back, making their last frames look stuck.
        readonly property list<real> expressiveFastSpatial: [0.22, 0.68, 0.32, 1.00, 1, 1]
        readonly property list<real> expressiveDefaultSpatial: [0.22, 0.68, 0.32, 1.00, 1, 1]
        readonly property list<real> expressiveSlowSpatial: [0.25, 0.50, 0.35, 1.00, 1, 1]
        readonly property list<real> expressiveEffects: [0.22, 0.68, 0.32, 1.00, 1, 1]
        readonly property list<real> emphasized: [0.22, 0.68, 0.32, 1.00, 1, 1]
        readonly property list<real> emphasizedFirstHalf: [0.05, 0, 2 / 15, 0.06, 1 / 6, 0.4, 5 / 24, 0.82]
        readonly property list<real> emphasizedLastHalf: [5 / 24, 0.82, 0.25, 1, 1, 1]
        readonly property list<real> emphasizedAccel: [0.3, 0, 0.8, 0.15, 1, 1]
        readonly property list<real> emphasizedDecel: [0.22, 0.68, 0.32, 1.00, 1, 1]
        readonly property list<real> standard: [0.2, 0, 0, 1, 1, 1]
        readonly property list<real> standardAccel: [0.3, 0, 1, 1, 1, 1]
        readonly property list<real> standardDecel: [0, 0, 0, 1, 1, 1]
        readonly property real expressiveFastSpatialDuration: 200
        readonly property real expressiveDefaultSpatialDuration: 250
        readonly property real expressiveSlowSpatialDuration: 300
    ...
    sizes: QtObject {
        // Larger top bar for the 14-inch HiDPI panel.
