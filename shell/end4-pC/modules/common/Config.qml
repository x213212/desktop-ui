    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject apps: JsonObject {
                ...
                property string changePassword: "gnome-terminal --wait -- /usr/bin/fish -i -C 'passwd'"
                property string network: "nm-connection-editor"
                property string manageUser: "cinnamon-settings-users"
                property string networkEthernet: "nm-connection-editor"
                property string taskManager: "gnome-system-monitor"
                property string terminal: "gnome-terminal --" // This is only for shell actions
                property string update: "mintupdate"
            ...
            property JsonObject bar: JsonObject {
                ...
                property JsonObject layouts: JsonObject {
                    property list<string> leftLayout: ["launcherButton", "workspaces", "remoteDesktopButton", "activeWindow"]
                    property list<string> middleLayout: ["clockWidget"]
                    property list<string> rightLayout: ["sysTray", "utilButtons", "mail", "calendar", "systemIcons", "powerButton"]
                }
                ...
                property JsonObject weather: JsonObject {
                    property bool enable: false
                    property bool enableGPS: false // Explicit opt-in: sends coordinates to the weather provider
            ...
            property JsonObject lock: JsonObject {
                // Compatibility field for older config files. The session now
                // has one authoritative weather lock owner: hyprlock.
            ...
            property JsonObject sidebar: JsonObject {
                ...
                // The notification bell opens this panel. Keeping the object
                // tree warm avoids rebuilding the entire sidebar on the click
