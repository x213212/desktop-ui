...
Item { // Notification item area
    ...
    readonly property string processedBody: NotificationUtils.processNotificationBody(
        ...
        ColumnLayout { // Content column
            ...
            ColumnLayout { // Expanded content
                ...
                StyledText { // Notification body (expanded)
                    ...
                    // RichText parsing is expensive.  Keep the collapsed
                    // delegate lightweight and populate it only on expansion.
                    text: root.expanded
                        ? `<style>img{max-width:${expandedContentColumn.width}px;}</style>${root.processedBody}`
                        : ""
                ...
                Item {
                    ...
                    layer.enabled: root.expanded && expandedContentColumn.visible
