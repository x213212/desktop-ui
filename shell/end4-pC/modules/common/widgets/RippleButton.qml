...
Button {
    ...
    // A 1.2 s ripple kept an off-screen texture alive long after the click.
    // Keep the feedback crisp and release the effect buffer quickly.
    property int rippleDuration: 280
    ...
    background: Rectangle {
        ...
        // OpacityMask requires an off-screen render target. Allocate it only
        // for the short interval in which the ripple is actually visible.
        layer.enabled: root.rippleEnabled && ripple.opacity > 0.001
