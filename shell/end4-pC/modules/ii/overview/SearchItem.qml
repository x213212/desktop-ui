            ...
            RowLayout {
                ...
                Repeater { // Favicons for links
                    ...
                    Favicon {
                        ...
                        // A Repeater delegate briefly has no visual parent
                        // while it is attached/destroyed.  Tie the favicon to
                        // the stable text metric instead of dereferencing it.
                        size: nameText.implicitHeight
                        url: modelData
                    }
                }
