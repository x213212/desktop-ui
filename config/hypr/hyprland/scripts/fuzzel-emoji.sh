...
# Source: https://github.com/end-4/dots-hyprland/blob/97c5bc651f68092351b24aaa935af708b1e04514/dots/.config/hypr/hyprland/scripts/fuzzel-emoji.sh
# Incorporates MIT-licensed wofi-emoji and emojilib data. The complete
# copyright and permission notices are in THIRD_PARTY_NOTICES.md.
